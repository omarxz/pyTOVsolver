...
pre_name = "fa15e15_ma3e-11_gsN3e-22"
...
ode_system.ma = 3e-11 * 1e-9 * cmToGeVInv
ode_system.fa = 1.5e16 * PhiFaGeVToCGs
...
def compute_for_rho_c(rho_c, g_s_N=g_s_N):
    ...
    result = minimize(continuity_cost, a_minimized/800, args=(rho_c,), method='Nelder-Mead', options={'maxiter': 250, 'xatol': 1e-9}) # OR maybe 150 is too much? default is 100
    if result.success: 
